...
export const HeroSection = ({
  ...
  return <section id="hero" className="min-h-screen flex items-center justify-center px-6 py-20">
      <div className="text-center max-w-4xl mx-auto">
        ...
        duration: 0.8,
        ease: 'easeOut'
      }} className="text-6xl md:text-8xl lg:text-9xl font-extrabold mb-12 tracking-tight text-foreground">
          PESU Minecraft
          <span className="block text-4xl md:text-6xl lg:text-7xl mt-2 font-light text-muted-foreground">S2</span>
        </motion.h1>
        ...
        duration: 0.6
          ...
          <button onClick={onOpenServerContents} className="inline-flex items-center gap-3 px-8 py-4 glass-button rounded-2xl font-semibold text-lg hover:scale-105 transition-all duration-300">
            Server Contents
          </button>
        </motion.div>
