        ...
        >
          ...
          <div className="flex gap-3 justify-center">
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#FF0000]/90 hover:bg-[#FF0000] rounded-2xl font-bold text-white transition-all duration-200 hover:scale-105"
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90 rounded-2xl font-bold text-white transition-all duration-200 hover:scale-105"
