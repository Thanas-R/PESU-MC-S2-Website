  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24">
      <div className="text-center max-w-6xl mx-auto w-full">
        ...
        >
          {/* Server Status */}
          <div className={`inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full border ${
            isOnline 
          ...
          {/* Player Count */}
          <div className="inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 glass-card rounded-full">
        ...
        >
          {/* Version Card - frosted glass */}
          <div className="glass-card px-6 sm:px-10 py-4 sm:py-6 rounded-2xl transition-[border-color] duration-200 hover:border-white/25">
          ...
          {/* IP Address Card - frosted glass */}
          <button
            onClick={handleCopyIP}
            className="glass-card px-6 sm:px-10 py-4 sm:py-6 rounded-2xl group cursor-pointer transition-[border-color] duration-200 hover:border-white/25"
          >
