  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24">
      <div className="text-center max-w-6xl mx-auto w-full">
        ...
        >
          {/* Social Icons - Stacked vertically to the left of Discord */}
          <div className="flex flex-col gap-2 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 transition-all duration-200 hover:scale-110"
              aria-label="Instagram"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24" className="w-full h-full">
