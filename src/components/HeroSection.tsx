  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24">
      <div className="text-center max-w-6xl mx-auto w-full">
        ...
        {/* HIDDEN ON MOBILE: container uses hidden sm:flex so mobile won't show it */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4 }}
          className="hidden sm:flex flex-wrap justify-center items-center gap-3 sm:gap-4 mb-6 sm:mb-8"
        >
