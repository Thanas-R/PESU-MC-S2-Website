  ...
  return <AnimatePresence>
      {isOpen && <>
        ...
        ease: 'easeOut'
            ...
            {/* Close button */}
            <button onClick={onClose} className="absolute top-6 right-6 p-2 rounded-full glass-button">
            ...
            <div className="grid md:grid-cols-2 gap-12 h-full">
              ...
              onOpenServerContents();
                ...
                delay: 0.5
              }} href="https://discord.com/invite/dVGj9pfG" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-[hsl(235,86%,65%)] hover:bg-[hsl(235,86%,58%)] rounded-xl font-semibold text-white transition-all duration-300">
                ...
                delay: 0.6
              }} href="https://pesu-mc.ddns.net:8443/status" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 glass-button rounded-xl font-semibold">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {adminPanel.admins.map(admin => <span key={admin} className="px-3 py-1.5 bg-white/10 border border-white/10 rounded-lg text-sm font-medium">
                          {admin}
                        </span>)}
                    </div>
                  </div>
                  ...
                  <div>
                    <p className="text-muted-foreground text-xs uppercase tracking-wider mb-1">Website & Marketing</p>
