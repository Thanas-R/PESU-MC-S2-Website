      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 p-2 rounded-full glass-button z-10 sm:hidden"
            >
              <X className="w-6 h-6" />
            </button>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {adminPanel.admins.map(admin => (
                        <span
                          key={admin}
                          className="px-2.5 sm:px-3 py-1 sm:py-1.5 bg-white/10 border border-white/10 rounded-lg text-xs sm:text-sm font-medium"
                        >
                          {admin}
                        </span>
                      ))}
