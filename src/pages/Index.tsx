  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 p-3 glass rounded-xl hover:scale-105 transition-transform duration-300"
        aria-label="Toggle menu"
      >
        <MenuToggleIcon open={isMenuOpen} className="w-8 h-8 text-foreground" duration={400} />
      </button>
      ...
      {/* Main Content with Scroll Stack */}
      <ScrollStack
      ...
      >
        ...
        {/* Footer */}
        <ScrollStackItem itemClassName="!min-h-[50vh]">
              ...
              <div className="glass-card p-8 rounded-3xl">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-discord hover:bg-discord-hover rounded-xl font-semibold transition-all duration-300"
                  >
